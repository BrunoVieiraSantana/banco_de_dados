...
Trânsito""", image=self.logo_image, compound="left", font=customtkinter.CTkFont(size=15, weight="bold"))
        ...
        self.third_frame_entry_search_motorista = customtkinter.CTkEntry(self.third_frame.tab("Motoristas"), placeholder_text="Nome ou Cpf")
        ...
        # Gráficos - Multas
        self.fourth_frame_label = customtkinter.CTkLabel(self.fourth_frame.tab("Multas") , text="Gráficos",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"))
        self.fourth_frame_label.grid(row=0, column=0, padx=30, pady=(15, 15))

        # Gráficos - Multas - figura
        ...
        canva = FigureCanvasTkAgg(self.fourth_frame_figure_multa, self.fourth_frame.tab("Multas"))
        canva.get_tk_widget().grid(row=1, column=0)

        # Gráficos - Multas - dados
        veiculos_lista = ('Carros', 'Motos', 'Caminhões', 'Ônibus')
        multas_lista = (7,8,1,3)
        y_pos = (1,2,3,4)
        ...
        self.fourth_frame_diagram_multa.set_title('Número de Multas diárias')
...
que deseja adicionar""",
        ...
        self.fifth_frame_entry_id_veiculo_add_multa = customtkinter.CTkEntry(self.fifth_frame_add_multa, placeholder_text="id veiculo")
        self.fifth_frame_entry_id_veiculo_add_multa.grid(row=1, column=0,  pady=(5, 5), sticky='n')
        self.fifth_frame_entry_id_motorista_add_multa = customtkinter.CTkEntry(self.fifth_frame_add_multa, placeholder_text="id motorista")
        self.fifth_frame_entry_id_motorista_add_multa.grid(row=2, column=0,  pady=5, sticky='n')
        self.fifth_frame_entry_data_add_multa = customtkinter.CTkEntry(self.fifth_frame_add_multa, placeholder_text="data")
        self.fifth_frame_entry_data_add_multa.grid(row=3, column=0,  pady=5, sticky='n')
...
#Botão para deletar motorista
    ...
    def button_search_multa(self):
        ...
        for veiculo in resultados:
            self.third_frame_table_search_multa.insert('', tkinter.END, values=veiculo)
...
#--------------------
    ...
    def  button_search_veiculo_delete(self):
        resultados = buscarMulta(con,self.fifth_frame_entry_delete_veiculo.get())
...
#--------------------
    ...
    def button_add_multa(self):
        ...
        inserirMulta(con,valor,data,motorista,automovel)
