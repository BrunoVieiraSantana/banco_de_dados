...
def show_error_id_not_found():
    CTkMessagebox(title="Error", message="""    Id não encontrado""", icon="cancel",cancel_button_color='transparent')
...
def show_error_no_result():
    CTkMessagebox(message="""A busca não encontrou nenhum resultado""",
                icon="info", option_1="Continuar",cancel_button_color='transparent', title='')

def show_error_search_blank():
    CTkMessagebox(message="""A caixa de busca está vazia""",
                icon="info", option_1="Continuar",cancel_button_color='transparent', title='')
...
def show_error_str_cpf_cnh():
    CTkMessagebox(title="Error", message="""    O CPF ou CNH deve possuir
      somente números""", icon="cancel",cancel_button_color='transparent')
...
def show_error_str_chassi():
    CTkMessagebox(title="Error", message="""       O Chassi e a Placa devem possuir
      somente números e letras""", icon="cancel",cancel_button_color='transparent')
    
def show_error_str_ForeignKeyIdMotorista():
    CTkMessagebox(title="Error", message=""" O Motorista em questão não consta no sistema, use um ID valido!""", icon="cancel",cancel_button_color='transparent')

def show_error_str_updateMotorista():
    CTkMessagebox(title="Error", message="""       O CPF e a CNH devem possuir
      somente números""", icon="cancel",cancel_button_color='transparent')
    
def show_error_str_updateAutomovel():
    CTkMessagebox(title="Error", message="""       O Chassi e a Placa devem possuir
      somente números e letras""", icon="cancel",cancel_button_color='transparent')
...
que deseja adicionar""",
        ...
        self.fifth_frame_entry_cpf_add_motorista = customtkinter.CTkEntry(self.fifth_frame_add_motorista, placeholder_text="CPF(11 dígitos)")
        self.fifth_frame_entry_cpf_add_motorista.grid(row=2, column=0,  pady=5, sticky='n')
        self.fifth_frame_entry_cnh_add_motorista = customtkinter.CTkEntry(self.fifth_frame_add_motorista, placeholder_text="CNH(11 dígitos)")
...
que deseja adicionar""",
        ...
        self.fifth_frame_entry_placa_add_veiculo = customtkinter.CTkEntry(self.fifth_frame_add_veiculo, placeholder_text="Placa(7 dígitos)")
        ...
        self.fifth_frame_combobox_add_veiculo = customtkinter.CTkOptionMenu(self.fifth_frame_add_veiculo, variable=self.fifth_frame_variable_add_veiculo, values=tipo_veiculos_add, command=select_callback_add,text_color=("#858585", "#9e9e9e"), button_color=("#979da2","gray50"),fg_color=("#f9f9fa", "gray30"))
...
que deseja atualizar""",
        ...
        self.fifth_frame_entry_placa_update_veiculo = customtkinter.CTkEntry(master=self.fifth_frame_update_veiculo, placeholder_text="Nova - Placa(7)")
        self.fifth_frame_entry_placa_update_veiculo.grid(row=4, column=0, pady=5, sticky="n")
        self.fifth_frame_entry_chassi_update_veiculo = customtkinter.CTkEntry(master=self.fifth_frame_update_veiculo, placeholder_text="Novo - Chassi(17)")
        ...
        #,button_color=("gray50", "light"),fg_color=("gray30", "light")
        self.fifth_frame_combobox_update_veiculo = customtkinter.CTkOptionMenu(self.fifth_frame_update_veiculo, variable=self.fifth_frame_variable_update_veiculo, values=tipo_veiculos_add, command=select_callback_add,text_color=("#858585", "#9e9e9e"), button_color=("#979da2","gray50"),fg_color=("#f9f9fa", "gray30"))
...
que deseja adicionar""",
        ...
        self.fifth_frame_entry_id_veiculo_add_multa = customtkinter.CTkEntry(self.fifth_frame_add_multa, placeholder_text="Placa(7 dígitos)")
        ...
        self.fifth_frame_label_update_multa = customtkinter.CTkLabel(self.fifth_frame_update_multa , text="""Busque e Selecione o ID da multa
que deseja atualizar""",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.fifth_frame_label_delete_multa = customtkinter.CTkLabel(self.fifth_frame_delete_multa , text="""Busque e Selecione o ID da multa
que deseja remover""",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.seventh_frame_entry_senha = customtkinter.CTkEntry(self.seventh_frame , placeholder_text="Senha",width=250, show="*")
...
#Botão para deletar motorista
    ...
    def button_search_veiculo(self):
        resultado = ""
        id = self.third_frame_entry_search_veiculo.get()
        if check_int(id) == False:
            placa = self.third_frame_entry_search_veiculo.get()
            placa_upper = placa.upper()
            resultado = placa_upper
        elif check_int(id) == True:
            resultado = id

        resultados = buscarAutomovel(con,resultado)
        if resultados == False:
            show_error_no_result()
        elif resultados != False:
    ...
    def button_add_motorista(self):
        ...
        elif inserirMotorista(con,name,cpf,cnh) == False:
            show_error_str_cpf_cnh()
    ...
    def button_update_motorista(self):
        ...
        elif updateMotorista(con,id_final, name, cpf, cnh) == "Error_":
            show_error_str_updateMotorista()
...
#--------------------
    ...
    def button_add_veiculo(self):
        ...
        elif inserirAutomovel(con, placa, chassi, tipo, id_motorista) == "_Error":
            show_error_str_chassi()

        elif inserirAutomovel(con, placa, chassi, tipo, id_motorista) == "Error_ForeignKeyViolation":
            show_error_str_ForeignKeyIdMotorista()
    ...
    def button_update_veiculo(self):
        ...
        elif updateAutomovel(con, id_final, placa, chassi, tipo, id_motorista) == "Error_":
            show_error_str_updateAutomovel()
    ...
    def  button_search_veiculo_update(self):
        placaUpper = self.fifth_frame_entry_update_veiculo.get()
        placaUpper2 = placaUpper.upper()
        
        resultados = buscarAutomovel(con,placaUpper2)
        if resultados == False:
            show_error_id_not_found()
    ...
    def  button_search_veiculo_delete(self):
        resultado = ""
        id = self.fifth_frame_entry_delete_veiculo.get()
        placa = self.fifth_frame_entry_delete_veiculo.get()
        placa_upper = placa.upper()
        if check_int(id) == False:
            resultado = placa_upper
        elif check_int(id) == True:
        ...
        if resultados == False or resultados == True:
            show_error_no_result() 
        else:
            for veiculo in resultados:
...
#--------------------
    ...
    def button_add_multa(self):
        ...
        automovelupper = automovel.upper()
        motorista_id = buscarIdMotorista(con, motorista)
        automovel_id = buscarPlacaAutomovel(con, automovelupper)
    ...
    def button_update_multa(self):
        ...
        if id_final == 0:
            ...
            self.fifth_frame_entry_valor_update_multa.delete(0, END)
            self.fifth_frame_entry_id_motorista_update_multa.delete(0, END)
            self.fifth_frame_entry_id_veiculo_update_multa.delete(0, END)
            self.fifth_frame_entry_update_multa.delete(0, END)
    ...
    def button_delete_multa(self):
        ...
        if id_final == 0:
            ...
            self.fifth_frame_entry_delete_multa.delete(0, END)
            ...
            self.fifth_frame_checkbox_delete_multa.deselect(0)
            id_final = 0
            show_checkmark_delete()
        else:
            show_checkmark_excluir()
...
# Login fuctions
    ...
    def get_veiculo(self):
        ...
        placaupper = placa.upper()
        try:
            motorista=buscarNomeMotorista(con,placaupper)
        except:
            show_error_no_result()
