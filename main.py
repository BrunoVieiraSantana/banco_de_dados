...
Trânsito""", image=self.logo_image, compound="left", font=customtkinter.CTkFont(size=15, weight="bold"))
        ...
        self.home_frame_login_button = customtkinter.CTkButton(self.home_frame , text="Esqueceu sua senha?", width=200, fg_color="transparent")
        self.home_frame_login_button.grid(row=4, pady=5)
        self.home_frame_login_button = customtkinter.CTkButton(self.home_frame , text="Criar conta", width=200, fg_color="transparent")
