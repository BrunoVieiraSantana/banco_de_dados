...
que deseja remover""",
        ...
        self.seventh_frame_entry_email.grid(row=5, column=0,  pady=(5,5), sticky='n')
...
#--------------------
    ...
    def button_add_multa(self):
        ...
        if len(valor) == 0 or len(motorista) == 0 or len(automovel) == 0:
            show_error_empty()
    ...
    def button_update_multa(self):
        ...
        if len(valor) == 0 or len(motorista) == 0 or len(automovel) == 0 or len(motorista) == 0:
            show_error_empty()
